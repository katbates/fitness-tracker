...
## Clean daily dataframes, to prepare to join
```{r echo=TRUE, message=FALSE, warning=FALSE}
...
table(total_check2)
```
Total_distance is not tracker + logged, and it is also not just tracker for all rows. Unclear how total_distance was calculated, so tracker_distance will be used as primary measure


###count unique id for activity, steps, calories, sleep, weight - shows usage