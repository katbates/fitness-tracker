...
library(corrplot)
num_only_daily <- daily_all_clean[, sapply(daily_all_clean, is.numeric)]
cor_daily <- cor(num_only_daily, use="pairwise.complete.obs")
...
Ideas for analysis:
* how variables change over the course of the day - hourly - do next two
* join hourly and show all three on same graph?
* Calculate average sleeptime and map onto steps chart - this will show best time to target ads
* Create graph with annotations about common behaviours during day - sleep, commute, work, exercise?
